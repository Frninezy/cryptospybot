...
mongo_client = pymongo.MongoClient("mongodb://<username>:<password>@<host>:<port>/")
...
# Function to get cryptocurrency rate and store it in MongoDB
def get_crypto_rate(crypto):
    ...
    # Store cryptocurrency price in MongoDB
    price_data = {
        "crypto": crypto,
        "price": rate,
...
# Function to get cryptocurrency rate history
